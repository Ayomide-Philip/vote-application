export default function MobileSideBar() {
  return (
    <>
      <div
        className="lg:hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-40 hidden"
        id="sidebar-overlay"
      ></div>

      {/* Mobile Sidebar */}
      <aside
        className="lg:hidden fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-50 transform -translate-x-full transition-transform duration-300 ease-in-out"
        id="mobile-sidebar"
      >
        {/* Logo */}
